                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="table-responsive small">
                        <table ng-controller="productListTable" class="table table-striped table-sm">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                            ...
                            <tbody>
                                <tr ng-repeat="x in productList">
                                    ...
                                    <td>
                                        <div class="btn-toolbar mb-2 mb-md-0">
                                            <div class="btn-group me-2">
                                                <a href="<?= base_url('product_upsert/') ?>{{x.product_id}}" class="btn btn-sm btn-secondary">
                                                    <!-- Edit SVG -->
                                                ...
                                                <button type="button" ng-click="deleteProduct(x.product_id)" class="btn btn-sm btn-danger">
                                                    <!-- Delete SVG -->
...
<script>
    angular.module('myApp').controller('productListTable', function($scope, $http) {
